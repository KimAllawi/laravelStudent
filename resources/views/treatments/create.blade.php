                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('Treatments.store') }}">
                                ...
                                <div class="col-md-6">
                                    <select id="appointment_id" type="text"
                                        ...
                                        @foreach ($dataPatients as $dataPatient)
                                            <option value="{{ $dataPatient->appointment_id }}">{{ $dataPatient->appointment_id }}
                                            </option>
                                        @endforeach
                            ...
                            {{-- <div class="row mb-3">
                                <label for="appointment_id"
                                    class="col-md-4 col-form-label text-md-end">{{ __('appointment_id') }}</label>

                                <div class="col-md-6">
                                    <input id="treatment_type" type="text"
                                        class="form-control @error('treatment_type') is-invalid @enderror"
                                        name="appointment_id" required autocomplete="appointment_id">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="treatment_type" type="text"
                                        class="form-control @error('treatment_type') is-invalid @enderror"
                                        name="treatment_type" required autocomplete="treatment_type">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="treatment_date" type="date"
                                        ...
                                        name="treatment_date" required autocomplete="new-treatment_date">
