                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" title="{{ Auth::user()->name }}"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{-- {{ Auth::user()->name }} --}}

                                <img src="dist/img/vecteezy_tooth-happy-character-cute_21880393.jpg" alt="AdminLTE Logo"
                            class="brand-image img-circle elevation-3 " style="width: 40px">
            ...
            <div class="form-inline">
                <div class="input-group" data-widget="sidebar-search">
                    ...
                    <div class="input-group-append">
                        ...
                        <form method="GET" action="{{ route('searchAppointments') }}" class="form-group my-3">
                            <input type="text" class=" form-control form-control-sidebar my-3 w-50 bg-light " name="searchAppointments" placeholder="SearchByName">
                            <button type="submit" class="btn btn-primary"> <i class="fas fa-search fa-fw"></i> </button>
                        </form>

                    </div>
                </div>
                <a href="{{ route('Appointments.create') }}" class="btn btn-info text-light">Create</a>
