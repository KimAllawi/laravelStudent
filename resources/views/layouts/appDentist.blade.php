            ...
            <div class="container" style="margin-left:250px">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('patients.create') }}">{{ __('Create') }}</a>
                            </li>
                        @endif
                    @else
                ...
                <div class="input-group" data-widget="sidebar-search">
                    ...
                    <div class="input-group-append">
                        ...
                        <form method="GET" action="{{ route('searchPatients') }}" class="form-group my-3">
                            <input type="text" class=" form-control form-control-sidebar my-3 w-50 bg-light "
                                name="searchPatient" placeholder="SearchByName">
                            <button type="submit" class="btn btn-primary"> <i class="fas fa-search fa-fw"></i>
                            </button>
                        </form>

                    </div>
                </div>
                <a href="{{ route('patients.create') }}" class="btn btn-info text-light">Create</a>
