            ...
            <div class="container" style="margin-left:250px">
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link fs-3 text-shadow-lg"
                                        href="{{ route('Treatments.index') }}">المستخدمين</a>
                                </li>
                                <li class="nav-item">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        @if (Route::has('login'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('treatments.create') }}">{{ __('Create') }}</a>
                            </li>
                        @endif
                    @else
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="form-inline">
                ...
                <a href="{{ route('Treatments.create') }}" class="btn btn-info text-light">Create</a>
