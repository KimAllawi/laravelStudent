        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('patients.destroy', $patient->patient_id)  }}">
                            @method('DELETE')
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email"
                                        ...
                                        autocomplete="new-email" value="{{ $patient->email }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="number"
                                        ...
                                        autocomplete="new-phone" value="{{ $patient->phone }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text"
                                        ...
                                        autocomplete="new-address" value="{{ $patient->address }}">
